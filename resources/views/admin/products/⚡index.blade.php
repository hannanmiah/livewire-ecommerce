...
<flux:main>
    ...
    <div class="flex flex-col gap-4 sm:flex-row mb-6">
        <flux:input wire:model.live.debounce="search" :placeholder="__('Search products...')" icon="magnifying-glass"
                    class="sm:max-w-sm"/>
                ...
                <flux:table.row :key="$product->id">
                    ...
                    <flux:table.cell align="end">
                        <div class="flex items-center justify-end gap-2">
                            <flux:button :href="route('admin.products.edit', $product)" variant="ghost" size="sm"
                                         wire:navigate>
                                {{ __('Edit') }}
                            </flux:button>
