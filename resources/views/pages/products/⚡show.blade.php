    ...
    <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <nav class="mb-6 flex items-center gap-2 text-sm text-zinc-500 dark:text-zinc-400">
            ...
            <a href="{{ route('products.index') }}" wire:navigate
               class="hover:text-zinc-700 dark:hover:text-zinc-300">{{ __('Products') }}</a>
            @if($product->category)
                <flux:icon icon="chevron-right" class="size-3.5"/>
                <a href="{{ route('products.by-category', $product->category->slug) }}" wire:navigate
                   class="hover:text-zinc-700 dark:hover:text-zinc-300">{{ $product->category->name }}</a>
            @endif
            <flux:icon icon="chevron-right" class="size-3.5"/>
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div class="space-y-6">
                {{-- Brand --}}
                @if($product->brand)
                    <a href="{{ route('products.by-brand', $product->brand->slug) }}" wire:navigate
                       class="inline-block text-sm font-medium text-zinc-500 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-300">
                        {{ $product->brand->name }}
                    </a>
                @endif
                    ...
                    <div class="flex items-center gap-2">
                        <div class="flex items-center">
                            @for($i = 1; $i <= 5; $i++)
                                ...
                                @else
                                    <svg class="size-5 text-zinc-300 dark:text-zinc-600" fill="currentColor"
                                         viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                @endif
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-center">
                                                @for($i = 1; $i <= 5; $i++)
                                                    @if($i <= $review->rating)
                                                        <svg class="size-4 text-amber-400" fill="currentColor"
                                                             viewBox="0 0 20 20">
                                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                                        </svg>
                                                    @else
                                                        <svg class="size-4 text-zinc-300 dark:text-zinc-600"
                    ...
                    @auth
                        @if($this->hasReviewed)
                            <div class="rounded-lg border border-zinc-200 p-4 text-center dark:border-zinc-700">
                                <flux:text
                                        class="text-sm text-zinc-500">{{ __('You have already reviewed this product.') }}</flux:text>
                            </div>
                        @else
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            ...
                                            >
                                                @if($reviewRating && $i <= $reviewRating)
                                                    <svg class="size-7 text-amber-400" fill="currentColor"
                                                         viewBox="0 0 20 20">
                                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                                    </svg>
                                                @else
                                                    <svg class="size-7 text-zinc-300 dark:text-zinc-600"
                                                         fill="currentColor" viewBox="0 0 20 20">
                                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                                    </svg>
                                                @endif
                    ...
                    @else
                        <div class="rounded-lg border border-zinc-200 p-4 text-center dark:border-zinc-700">
                            <flux:text class="text-sm text-zinc-500">
                                {{ __('Please') }}
                                <a href="{{ route('login') }}"
                                   class="font-medium text-zinc-900 underline dark:text-zinc-100">{{ __('log in') }}</a>
                            ...
                            <a href="{{ route('products.show', $relatedProduct->slug) }}" wire:navigate class="block">
                                ...
                                <div class="mt-3 space-y-1">
                                    @if($relatedProduct->brand)
                                        <flux:text
                                                class="text-xs text-zinc-500 dark:text-zinc-400">{{ $relatedProduct->brand->name }}</flux:text>
                                    @endif
                                    <flux:text variant="strong"
                                               class="text-sm line-clamp-1">{{ $relatedProduct->name }}</flux:text>
                                    @php
